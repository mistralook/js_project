...
- Кнопка "Завершить игру" вместо "Результаты" (будет всегда показываться)

- Несгораемые суммы

- Подсветка кнопок (правильный | неправильный ответ)

- Анимация на таймер (типа истекает время)

- Подождать при переходе между вопросами (1-2-3 секунды)

- Объявлять о победе | поражении
...
Если успеем:
третья подсказка, куки, избавиться от инъекции, минимизация кода
